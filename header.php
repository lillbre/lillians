...
<head>
  ...
  <script src="https://kit.fontawesome.com/831f147a34.js" crossorigin="anonymous"></script>
  <?php wp_head(); ?>
  <title>Lillians</title>
</head>
<body>
  ...
  <nav>
    <div id = "logo-img">
      <a href ="<?php echo site_url('');?>">
        <img src="<?php echo get_template_directory_uri();?>/img/logo1.png" alt ="lillians logo">
      </a>
    </div>
   <div id = "menu-icon">
